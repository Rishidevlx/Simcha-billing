...
export default function InvoiceTemplate({ bill, settings }) {
  ...
  return (
    <div
      ...
      className="relative bg-white text-[#292424] font-['Poppins',sans-serif] w-[210mm] min-h-[297mm] mx-auto p-8 flex flex-col justify-between shadow-lg print:shadow-none print:p-6 print:w-full print:min-h-screen text-[12px] leading-relaxed overflow-hidden box-border"
      style={{ boxSizing: 'border-box' }}
    >
      {/* Background Watermark (Favicon.jpeg Shield Logo) */}
      ...
      <div className="relative z-10 space-y-4 flex-1">
        ...
        {/* 1. Official Letterhead Header (No Badges) */}
        ...
        {/* 2. Invoice Meta Bar (Neutral Gray Ribbon) */}
        ...
        {/* 3. Customer Bill To Details (One-By-One Rows) */}
        <div className="border border-gray-300 p-3.5 space-y-1 bg-white/80 text-[#292424]">
          <span className="text-[10px] font-black text-[#292424] uppercase tracking-wider block mb-1">
            BILL TO
          </span>
          ...
          <div className="space-y-0.5 pt-1.5 text-[11px] font-medium text-gray-700">
            {bill.customer_phone && (
              <div>
          ...
          <table className="w-full text-left border-collapse text-[11px]">
            <thead>
              <tr className="bg-[#f3f4f6] border-b border-gray-300 text-[10px] font-black uppercase text-[#292424]">
                <th className="py-2 px-3 border-r border-gray-300 w-[42%]">ITEMS</th>
                ...
                <th className="py-2 px-2 border-r border-gray-300 text-right w-[12%]">RATE (₹)</th>
                <th className="py-2 px-2 border-r border-gray-300 text-right w-[12%]">TAX</th>
            ...
            <tfoot>
              <tr className="bg-[#f3f4f6] border-t border-gray-300 font-bold text-[11px] text-[#292424]">
                <td className="py-2 px-3 border-r border-gray-300 uppercase text-[#292424]">SUB TOTAL</td>
                <td className="border-r border-gray-300" />
                <td className="py-2 px-2 border-r border-gray-300 text-center font-mono text-[#292424]">{formatQty(totalQty)}</td>
                <td className="border-r border-gray-300" />
        ...
        {/* 5. Bottom Two-Column Split (Spacious & Clean Borderless Layout) */}
        <div className="grid grid-cols-12 gap-6 pt-3 text-[#292424]">
          
          {/* Left Column: Bank Details & Terms & Conditions (Borderless, One-by-One) */}
          <div className="col-span-7 space-y-4">
            
            {/* Bank Details (One by One vertical list) */}
            <div className="space-y-1 text-[11px]">
              <span className="font-black text-[#292424] uppercase tracking-wider block text-[11px] mb-1.5">
                BANK DETAILS
              </span>
          ...
          {/* Right Column: Tax Breakdown, Totals & Signatory (Spacious, Borderless like Demo PDF) */}
          <div className="col-span-5 flex flex-col justify-between text-[#292424] pl-2">
            ...
            <div className="pt-27 text-center space-y-1">
      ...
      {/* 6. Exact Brand Footer Ribbon matching image.png / letterhead-template.png */}
      <div className="relative z-10 -mx-8 -mb-8 mt-6 print:-mx-6 print:-mb-6 overflow-hidden">
        <div className="bg-[#043486] text-white py-3.5 px-6 flex items-center justify-between text-[11px] font-medium">
          
          {/* Left: 2 stacked rows for Phone & Email with white circular icon pills */}
          <div className="space-y-1.5 shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="w-5 h-5 rounded-full bg-white text-[#043486] flex items-center justify-center shrink-0 shadow-xs">
                <Phone size={10} fill="#043486" />
              </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <span className="tracking-wide text-[10.5px]">{companyEmail}</span>
            </div>
          </div>

          {/* Center Slanted Divider matching template */}
          <div className="h-9 w-[1.5px] bg-white/40 rotate-[25deg] mx-4 shrink-0" />

          {/* Right: Address with circular icon pill */}
          <div className="flex items-center gap-2.5 max-w-sm">
            <div className="w-5 h-5 rounded-full bg-white text-[#043486] flex items-center justify-center shrink-0 shadow-xs">
              <MapPin size={10} fill="#043486" />
            </div>
            <span className="leading-snug text-[10px]">{companyAddress}</span>
          </div>
